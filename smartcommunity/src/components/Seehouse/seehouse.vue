...
export default {
  ...
  computed: {
      types(){
          return this.$store.state.myhouse.seehouse;
      },
      types_detail(){
          return this.$store.state.myhouse.seehouse_value;
      }
  },
  mounted() {
        this.$store.dispatch('myhouse/see_houserender',{type: this.$route.query});
